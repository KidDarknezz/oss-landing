...
import Banner1Mobile from '@/assets/images/project_veasa_banner_1_mobile.png'
import Banner2 from '@/assets/images/project_veasa_banner_2.png'
import Banner2Mobile from '@/assets/images/project_veasa_banner_2_mobile.png'
import Hero from '@/assets/images/project_veasa_hero.png'
import HeroMobile from '@/assets/images/project_veasa_hero_mobile.png'
...
export default function veasaComp() {
  return {
    ...
    banners: [Banner1, 'https://www.youtube.com/embed/Y0EHb1V8pDM?si=Aa-X7G_Glxr9a1nr', Banner2],
    bannersMobile: [
      Banner1Mobile,
      'https://www.youtube.com/embed/Y0EHb1V8pDM?si=Aa-X7G_Glxr9a1nr',
      Banner2Mobile,
    ],
    bottomCopy:
